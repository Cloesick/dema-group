      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div>
          <Link href="/" className="flex justify-center">
            <span className="text-3xl font-bold text-primary">DemaShop</span>
          </Link>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">
                  {oauthError === 'OAuthSignin' ? 'OAuth authentication failed. Please try again or use email/password.' :
                   oauthError === 'OAuthCallback' ? 'OAuth callback error. Please check your configuration.' :
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">{t('auth.or')} {t('auth.continue_with_google').split(' ').slice(0, 2).join(' ')}</span>
              </div>
            </div>
          ...
          <div className="mt-6">
            <p className="text-xs text-center text-gray-500">
              Admins: Use email ending in <span className="font-semibold">@demashop.be</span> or the designated Gmail account
            </p>
          </div>
        </div>
      </div>
