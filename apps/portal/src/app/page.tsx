                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {category.subcategories.map((subcategory, subIndex) => {
                    ...
                    const subcategoryImages: Record<string, string> = {
                      'centrifugal-pumps': '/images/subcategories/centrifugal-pump.webp',
                      'submersible-pumps': '/images/subcategories/submersible-pump.webp',
                      'piston-pumps': '/images/subcategories/centrifugal-pump.webp',
                      'pump-accessories': '/images/subcategories/pressure-gauge.webp',
                      'plastic-pipes': '/images/subcategories/pipe-fitting.webp',
                      'metal-pipes': '/images/subcategories/pipe-fitting.webp',
                      'fittings': '/images/subcategories/pipe-fitting.webp',
                      'industrial-hoses': '/images/subcategories/hose-coupling.webp',
                      'couplings': '/images/subcategories/hose-coupling.webp',
                      'ball-valves': '/images/subcategories/ball-valve.webp',
                      'butterfly-valves': '/images/subcategories/butterfly-valve.webp',
                      'check-valves': '/images/subcategories/ball-valve.webp',
                      'actuators': '/images/subcategories/actuator.webp',
                      'sprinklers': '/images/subcategories/sprinkler.webp',
                      'drip-irrigation': '/images/subcategories/drip-irrigation.webp',
                      'irrigation-controls': '/images/subcategories/pressure-gauge.webp',
                      'industrial-belts': '/images/subcategories/conveyor-belt.webp',
                      'food-grade-belts': '/images/subcategories/conveyor-belt.webp',
                      'belt-accessories': '/images/subcategories/conveyor-belt.webp',
                      'screws': '/images/subcategories/screw-fastener.webp',
                      'nuts-washers': '/images/subcategories/screw-fastener.webp',
                      'standoffs-spacers': '/images/subcategories/screw-fastener.webp',
                      'power-tools': '/images/subcategories/power-tool.webp',
                      'pressure-washers': '/images/subcategories/power-tool.webp',
                      'compressors': '/images/subcategories/power-tool.webp',
                    }
