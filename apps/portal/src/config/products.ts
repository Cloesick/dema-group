  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        id: 'actuator',
        name: 'Actuators',
        image: '/images/products/fluxer-actuator.webp',
        description: 'Pneumatic and electric actuators for valve automation',
      },
      {
        id: 'instrumentation',
        name: 'Instrumentation',
        image: '/images/products/fluxer-instrumentation.webp',
    ...
    products: [
      {
        id: 'conveyor',
        name: 'Conveyor Belts',
        image: '/images/products/beltz247-conveyor.webp',
    ...
    products: [
      {
        ...
        image: '/images/products/devisschere-sprinkler.webp',
        description: 'Pop-up sprinklers, rotors, and controllers',
      },
      {
        id: 'drip',
        name: 'Drip Irrigation',
        image: '/images/products/devisschere-drip.webp',
    ...
    products: [
      {
        ...
        image: '/images/products/accu-screws.webp',
